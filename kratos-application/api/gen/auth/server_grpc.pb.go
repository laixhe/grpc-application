...
const (
	SAuth_RegisterLogin_FullMethodName = "/auth.SAuth/RegisterLogin"
	SAuth_Refresh_FullMethodName       = "/auth.SAuth/Refresh"
)
...
type SAuthClient interface {
	// 登录注册
	RegisterLogin(ctx context.Context, in *RegisterLoginRequest, opts ...grpc.CallOption) (*RegisterLoginResponse, error)
	// 刷新Jwt
...
func (c *sAuthClient) RegisterLogin(ctx context.Context, in *RegisterLoginRequest, opts ...grpc.CallOption) (*RegisterLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterLoginResponse)
	err := c.cc.Invoke(ctx, SAuth_RegisterLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSAuthServer) RegisterLogin(context.Context, *RegisterLoginRequest) (*RegisterLoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterLogin not implemented")
}
...
func _SAuth_RegisterLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SAuthServer).RegisterLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SAuth_RegisterLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SAuthServer).RegisterLogin(ctx, req.(*RegisterLoginRequest))
	}
...
var SAuth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.SAuth",
	HandlerType: (*SAuthServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RegisterLogin",
			Handler:    _SAuth_RegisterLogin_Handler,
		},
		{
			MethodName: "Refresh",
	...
	Metadata: "proto/auth/server.proto",
}
